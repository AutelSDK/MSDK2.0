...
public class KeyItemsWrapper<P, R> extends KeyBaseStructure {
    ...
    public void getList(List<KeyItem> keyItemList) {
        ...
        printAndToast(true, keyItemWrapperListener, false,
                SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_get_all),
                SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_begin), Collections.singletonList("begin ..."));
        printAndToast(true, keyItemWrapperListener, false,
                SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_get_all), SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_begin), getKeyItemNameList(keyItemList));
        ...
        getList(keyInfoList, new CommonCallbacks.CompletionCallbackWithParam<List>() {
            ...
            public void onFailure(@NonNull IAutelCode code, @Nullable String errorMsg) {
                ...
                printAndToast(true, keyItemWrapperListener, true,
                        SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_get_all),
                        SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_failed), Collections.singletonList(msg));
            }
            ...
            public void onSuccess(@Nullable List data) {
                printAndToast(true, keyItemWrapperListener, false,
                        SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_get_all),
                        SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_success), data);
            }
        });
    }
    ...
    public void setList(List<KeyItem> keyItemList) {
        ...
        printAndToast(true, keyItemWrapperListener, false,
                SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_set_all), SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_begin), Collections.singletonList("begin ..."));
        printAndToast(true, keyItemWrapperListener, false,
                SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_set_all), SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_begin), getKeyItemNameList(keyItemList));
        ...
        setList(keyInfoList, paramList, new CommonCallbacks.CompletionCallbackWithParam<List<?>>() {
            ...
            public void onFailure(@NonNull IAutelCode code, @Nullable String errorMsg) {
                ...
                printAndToast(true, keyItemWrapperListener, true,
                        SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_set_all),
                        SDKManager.get().getSContext().getString(com.autel.drone.demo.R.string.debug_failed), Collections.singletonList(msg));
            }
